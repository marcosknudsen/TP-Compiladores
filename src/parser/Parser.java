...
case 6:
//#line 31 "..\gramatica.y"
{yyval=new ParserVal(crear_terceto("begfunct",new ParserVal("-"),new ParserVal("-")));pila.push(reglas.size());}
break;
case 7:
//#line 34 "..\gramatica.y"
...
case 27:
//#line 96 "..\gramatica.y"
{ParserVal PV = new ParserVal(crear_terceto("BF",new ParserVal("["+(reglas.size()-1)+"]"),new ParserVal("-")));pila.push(reglas.size()-1);yyval=PV;}
break;
case 29:
//#line 102 "..\gramatica.y"
{yyval=new ParserVal(crear_terceto(">",val_peek(2),val_peek(0)));}
break;
case 30:
...
{yyval=new ParserVal(crear_terceto("ret",val_peek(1),new ParserVal("-")));}
break;
case 45:
...
//#line 137 "..\gramatica.y"
{
        ...
        yyval=new ParserVal(crear_terceto("endfun",val_peek(4),new ParserVal("-"),errores));
        t=reglas.get(pila.peek()-1);
        t.a=val_peek(4);
        t.b=val_peek(2);
        reglas.set(pila.pop()-1,t);
...
//#line 152 "..\gramatica.y"
{
        ...
        yyval=new ParserVal(crear_terceto("endfun",val_peek(3),new ParserVal("-"),errores));
        t=reglas.get(pila.peek()-1);
        t.a=new ParserVal(val_peek(3).sval);
        reglas.set(pila.pop()-1,t);
        colaAmbito.remove(colaAmbito.size()-1);
        if (!errores.contains("declared")){
...
//#line 167 "..\gramatica.y"
{
        for (int i=0; i<variables.size(); i++) {
            ...
            if(buscarVariable(val_peek(0).sval)!=null)
                errores.add("declared");
            crear_terceto("decl",val_peek(2),new ParserVal(variables.get(i)),errores);
...
//#line 188 "..\gramatica.y"
{
        ...
        yyval=new ParserVal(crear_terceto("+",val_peek(2),val_peek(0),errores));}
break;
case 62:
...
{yyval=new ParserVal(crear_terceto("exec",val_peek(2),new ParserVal("-")));pilaString.push(buscarVariable(val_peek(2).sval).tipo);}
break;
case 75:
//#line 230 "..\gramatica.y"
{
        ...
        yyval=new ParserVal(crear_terceto("exec",val_peek(3),val_peek(1)));}
break;
//#line 933 "Parser.java"
